...
print("\n LOADING EXPERIMENT 1 DEPENDENCIES")
...
assert not np.any(np.isnan(X_syn)), " NaN in scaled synthetic data"
assert not np.any(np.isinf(X_syn)), "Inf in scaled synthetic data"
print(f"scaled with real-data scaler, no NaN/Inf")
...
print("EXPERIMENT 1 vs EXPERIMENT 2 COMPARISON (RQ2)")
